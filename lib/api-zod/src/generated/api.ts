...
export const GetRecentAttemptsResponseItem = zod.object({
  ...
  sectionType: zod.enum(["mcq", "essay"]),
...
export const getExamResponseTwoQuestionsItemQuestionTypeDefault = `mcq`;
    ...
    zod.object({
      questions: zod.array(
        zod.object({
          ...
          questionType: zod
            .enum(["mcq", "essay"])
            .default(getExamResponseTwoQuestionsItemQuestionTypeDefault),
...
export const createQuestionBodyQuestionTypeDefault = `mcq`;
...
export const CreateQuestionBody = zod.object({
  questionType: zod
    .enum(["mcq", "essay"])
    .default(createQuestionBodyQuestionTypeDefault),
  topic: zod.string().nullish(),
  ...
  options: zod
    ...
    .optional(),
  correctIndex: zod.number().min(createQuestionBodyCorrectIndexMin).optional(),
  essayAnswer: zod.string().nullish(),
  explanation: zod.string().nullish(),
  reference: zod.string().nullish(),
  repeatNote: zod.string().nullish(),
...
export const bulkImportQuestionsBodyQuestionsItemQuestionTypeDefault = `mcq`;
  ...
  questions: zod
    .array(
      zod.object({
        questionType: zod
          .enum(["mcq", "essay"])
          .default(bulkImportQuestionsBodyQuestionsItemQuestionTypeDefault),
        topic: zod.string().nullish(),
        prompt: zod.string().min(1),
        options: zod
          .array(zod.string().min(1))
...
export const updateQuestionResponseQuestionTypeDefault = `mcq`;
...
export const UpdateQuestionResponse = zod.object({
  ...
  questionType: zod
    .enum(["mcq", "essay"])
    .default(updateQuestionResponseQuestionTypeDefault),
  topic: zod.string().nullish(),
  prompt: zod.string(),
  options: zod.array(zod.string()),
  correctIndex: zod.number(),
...
export const startAttemptBodySectionTypeDefault = `mcq`;
export const startAttemptBodyTimeLimitMinutesMax = 300;
...
export const StartAttemptBody = zod.object({
  ...
  sectionType: zod
    .enum(["mcq", "essay"])
    .default(startAttemptBodySectionTypeDefault),
  timeLimitMinutes: zod
    .number()
    .min(1)
    .max(startAttemptBodyTimeLimitMinutesMax)
    .nullish(),
  userName: zod.string().nullish(),
});
...
export const submitAnswerBodyElapsedSecondsMin = 0;

export const SubmitAnswerBody = zod.object({
  attemptQuestionId: zod.string(),
  selectedIndex: zod.number().min(submitAnswerBodySelectedIndexMin).optional(),
  essayAnswer: zod.string().optional(),
  elapsedSeconds: zod
    .number()
    .min(submitAnswerBodyElapsedSecondsMin)
    .optional(),
});
...
export const finishAttemptBodyElapsedSecondsMin = 0;

export const FinishAttemptBody = zod.object({
  elapsedSeconds: zod
    .number()
    .min(finishAttemptBodyElapsedSecondsMin)
    .optional(),
});
 ...
 */
export const SubmitLeaderboardEntryParams = zod.object({
  examId: zod.coerce.string(),
});

export const submitLeaderboardEntryBodyScoreMin = 0;

export const submitLeaderboardEntryBodyElapsedSecondsMin = 0;

export const SubmitLeaderboardEntryBody = zod.object({
  userName: zod.string().min(1),
  score: zod.number().min(submitLeaderboardEntryBodyScoreMin),
  total: zod.number().min(1),
  elapsedSeconds: zod
    .number()
    .min(submitLeaderboardEntryBodyElapsedSecondsMin)
    .optional(),
});
 ...
 */
export const GetUserPreferencesResponseItem = zod.object({
  key: zod.string(),
  value: zod.string(),
  updatedAt: zod.coerce.date(),
});
export const GetUserPreferencesResponse = zod.array(
  GetUserPreferencesResponseItem,
);
